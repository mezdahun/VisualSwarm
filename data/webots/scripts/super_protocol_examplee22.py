...
# Path of world file
wbt_path = f"/home/mezey/Webots_VSWRM/VisualSwarm/data/webots/VSWRM_WeBots_Project/worlds/VSWRM_{num_robots}Bots_OptiTrackArena_withPhysics_imp_tallhelo.wbt"
    ...
    for beti, betha_0 in enumerate(bethas):
        ...
        while run_i < num_runs:
            ...
            if num_running_processes < num_max_processes:
                ...
                # todo: try --no-rendering flag
                os.system(f"WEBOTS_CONFBASEPATH={base_path} nohup env WEBOTS_CONFBASEPATH={base_path} webots --no-rendering --mode=realtime --batch --stdout --stderr --minimize {wbt_path} &")
