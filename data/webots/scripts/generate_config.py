...
target_path = 'C:\\Users\\David\\Documents\\VisualSwarm\\controllers\\blank_controller\\robot_config_midpolline3.json'
num_robots = 6
...
orientation_type = {'type': 'uniform',  # distribtion of heading angles
                    'lim': 2,        # possible deviation of heading angles of agents (with each other)
