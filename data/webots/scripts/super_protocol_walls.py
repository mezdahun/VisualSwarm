...
base_path = "/home/mezey/Webots_VSWRM/VisualSwarm/data/webots/VSWRM_WeBots_Project/controllers/VSWRM-controller/config1"

wbt_path = "/home/mezey/Webots_VSWRM/VisualSwarm/data/webots/VSWRM_WeBots_Project/worlds/VSWRM_3Bots_10mArena.wbt"
num_robots = 3
    ...
    for beti, betha_0 in enumerate(bethas):
        ...
        for run_i in range(num_runs):
            ...
            env_config_dict = {
                ...
                'WEBOTS_SAVE_SIMULATION_VIDEO': str(int(False)),  # save video automatically
