...
num_clus_matrix = np.zeros((len(betas), num_runs))
acc_matrix_final = np.zeros((len(betas), num_runs))
acc_matrix_final_std = np.zeros_like(acc_matrix_final)
pol_over_wall_dist = np.zeros((len(betas), num_runs, 400, 2))
iidrats_over_exps = np.zeros((len(betas), num_runs, 60))
valid_ts_matrix_final = np.zeros((len(betas), num_runs))
abs_vel_m_final = np.zeros((len(betas), num_runs))
abs_vel_m_final_std = np.zeros((len(betas), num_runs))
turn_rate_m_final = np.zeros((len(betas), num_runs))
turn_rate_final_std = np.zeros((len(betas), num_runs))
time_above_pol = np.zeros((len(betas), num_runs))
time_in_iid_tolerance = np.zeros((len(betas), num_runs))
comv_matrix_final = np.zeros((len(betas), num_runs))
comv_matrix_final_std = np.zeros((len(betas), num_runs))
ord_matrix_final = np.zeros((len(betas), num_runs))
ord_matrix_final_std = np.zeros((len(betas), num_runs))
pol_matrix_final = np.zeros((len(betas), num_runs))
pol_matrix_final_std = np.zeros((len(betas), num_runs))
iid_matrix_final = np.zeros((len(betas), num_runs))
iid_matrix_final_std = np.zeros((len(betas), num_runs))
coll_times = np.zeros((2, len(betas), num_runs))
