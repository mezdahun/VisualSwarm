...
ax[0].axvline(lhalfline, 0, mlarge[lhalflinei], label="$R^{pol}_{thr+}$=0.5", color="#77dd77", linestyle="--")
ax[0].axhline(mlarge[lhalflinei], 0, lhalfline, color="#77dd77", linestyle="--")
...
ax[1].axvline(lblhalfline, 0, mlargebl[lblhalflinei], label="$R^{pol}_{thr+}$=0.5", color="#77dd77", linestyle="--")
ax[1].axhline(mlargebl[lblhalflinei], 0, lblhalfline, color="#77dd77", linestyle="--")
...
plt.plot(x, mlarge, label="$R^{pol}_{thr+}$ with exploration", color="#77dd77", linewidth="3")

#error_band = plt.fill_between(x, msmall-stdsmall, msmall+stdsmall, alpha=0.5, edgecolor="#ffcc89", facecolor="#ffcc89")
plt.plot(x, msmall, label="$R^{pol}_{thr+}$ no exploration", color="#ffcc89", linewidth="3")
