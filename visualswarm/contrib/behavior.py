...
ALP0 = behave_params_dict.get('ALP0', 250)
ALP1 = behave_params_dict.get('ALP1', 0.0007)
ALP2 = behave_params_dict.get('ALP2', 0)

# Heading Vector Parameters
BET0 = behave_params_dict.get('BET0', 0.5)
BET1 = behave_params_dict.get('BET1', 0.0007)
